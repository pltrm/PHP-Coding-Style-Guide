...
- НЕ СЛЕДУЕТ превышать длину строки в 120 символов. Более длинные строки СЛЕДУЕТ разбивать на несколько отдельных строк, длина каждой из которых не превышала бы 120 символов.
